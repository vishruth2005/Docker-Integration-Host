# Generated by Django 5.2.1 on 2025-07-01 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auth_type",
                    models.CharField(
                        choices=[("none", "None"), ("tls", "TLS"), ("ssh", "SSH")],
                        default="none",
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("internal_ports", models.JSONField(blank=True, null=True)),
                ("port_bindings", models.JSONField(blank=True, null=True)),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="editable_containers",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="viewable_containers",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                ...
                (
                    "volumes",
                    models.ManyToManyField(
                        blank=True, related_name="containers", to="api.volume"
                    ),
                ),
            ],
        ),
