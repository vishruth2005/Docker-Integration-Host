...
from .views import container_connected_networks, create_exec_session, get_volumes_by_host, create_volume, delete_volume, delete_container, get_container_volume_bindings, cleanup_container_networks
...
urlpatterns = [
    ...
    path('<int:host_id>/<str:container_id>/networks/cleanup/', cleanup_container_networks, name='cleanup-container-networks'),
